SERVICE = kb_busco
SERVICE_CAPS = kb_busco
SPEC_FILE = kb_busco.spec
URL = https://kbase.us/services/kb_busco
DIR = $(shell pwd)
LIB_DIR = lib
SCRIPTS_DIR = scripts
TEST_DIR = test
...
# Python-only module: Java codegen flags removed (modern JDKs lack javax.annotation.Generated).
compile:
...
build-test-script:
	...
	echo 'python -m pytest -v -s --cov=$(SERVICE_CAPS) --cov-report=html:/kb/module/work/test_coverage .' >> $(TEST_DIR)/$(TEST_SCRIPT_NAME)
